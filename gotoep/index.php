<?php 
	...
	include("../include/config.php"); //go to one folder back. congif.php is the connection file
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap nopadding">
				...
				<div class="section nopadding nomargin" style="width: 100%; height: 100%; position: absolute; left: 0; top: 0; background: url('../images/login1.jpg') center center no-repeat; background-size: cover;"></div>

				<div class="section nobg full-screen nopadding nomargin">
					<div class="container vertical-middle divcenter clearfix">

						<div class="row center">
							<a href="index.php"><img height="50px" src="../images/logo-footer1.jpg" alt="Exceptional Programmers"></a>
						</div>
