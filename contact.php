...
<?php
    ...
    if(isset($_POST['submit'])){        
        ...
        if( ( isset($name) && !empty($name) ) && ( isset($email) && !empty($email) ) && ( isset($user_msg) && !empty($user_msg) ) && ( isset($phone) && !empty($phone) ) ) {
            ...
            $to = "kashfia2812@gmail.com"; //Programmers email
				...
				<div class="container clearfix">
					...
					<div class="sidebar col_last nobottommargin">
						...
						<div class="widget noborder notoppadding">
							...
							<a target="_blank" href="https://www.facebook.com/kashfia.hasan.980/" class="social-icon si-small si-dark si-facebook">
							...
							<a target="_blank" href="https://www.youtube.com/channel/UCr4e_1GjT2NM76uxlmw0t4A" class="social-icon si-small si-dark si-youtube">
							...
							<a target="_blank" href="https://github.com/Kashfia1914" class="social-icon si-small si-dark si-github">
