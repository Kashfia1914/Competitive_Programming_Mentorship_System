...
<head>
	...
	<meta name="author" content="FlexMind" />
	<meta name=description content="FlexMind">
		...
		<header id="header" class=" full-header" data-sticky-class="not-dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.php?pag=home" class="standard-logo" data-dark-logo="images/logo-footer1.png"><img src="images/logo-footer1.png" alt="FlexMind Logo"></a>
						<a href="index.php?page=home" class="retina-logo" data-dark-logo="images/logo-footer1.png"><img src="images/logo-footer1.png" alt="FlexMind Logo"></a>
					</div><!-- #logo end -->
