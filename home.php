						...
						<div class="swiper-slide dark">
							<div class="container clearfix">
								<div class="slider-caption slider-caption-center">
									<h2 data-caption-animate="fadeInUp">We are FlexMind</h2>
					...
					<div class="row topmargin-lg bottommargin-sm">
						...
						<div class="col-md-4 col-sm-6 bottommargin">
							...
							<div class="feature-box fbox-right topmargin" data-animate="fadeIn">
								...
								<h3>Qualified, Passionate Mentors</h3>
								<p>We have Exceptional Certified Professional Mentors that deliver video lectures.</p>
							</div>
						...
						<div class="col-md-3 hidden-sm bottommargin center">
							<img src="Untitled design.png" alt="Design">
						</div>
...
<?php
        		...
        		while( $row2 = mysqli_fetch_assoc($result2) ){
					...
					if($status=='image'){			
						...
						echo'<div>
								<a href="blog.php?id='.$postId.'"><iframe width="150px" height="150px" src="https://www.youtube.com/channel/UCr4e_1GjT2NM76uxlmw0t4A'.$post.'" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></a>
								</div>';
					}			
